...
| [`13_readable_report.py`](13_readable_report.py) | Combined readable report: compact Markdown facts plus JSON-ready attributes/promotion candidates; spaCy details are opt-in. | none by default; `lede-spacy` for `backend="spacy"` details |
